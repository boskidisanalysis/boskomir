...
import { useSelectionBounds } from '@/hooks/use-selection-bounts'
    ...
    ({ onResizeHandlePointerDown }: SelectionBoxProps) => {
        ...
        return (
            <>
                <rect
                    className={
                        'pointer-events-none fill-transparent stroke-purple-500 stroke-1'
                    }
                    style={{
                        ...
                        {boundsHandler(bounds).map(
                            ({ cursor, resizeSide, transform: { x, y } }) => (
                                <rect
                                    key={nanoid()}
                                    className={
                                        'fill-white stroke-purple-500 stroke-1'
                                    }
                                    x={0}
                                    y={0}
                                    style={{
